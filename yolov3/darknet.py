...
if __name__ == "__main__":
    print(performDetect(imagePath='/disk5/zhaoliang/ClothDataSet/VOC2007/JPEGImages/J01_2018.06.13_13_25_43-11.jpg',
                        configPath='cloth/train.cfg',
                        metaPath='cloth/voc.data',
                        weightPath='cloth/backup/train_3408.weights',
                        thresh=0.25,
                        showImage=False
                        ))
